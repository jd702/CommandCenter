...
function Player(props) {
  ...
  const rowView = () => /*#__PURE__*/_react.default.createElement(RowBox, {
  ...
  const columnView = () => /*#__PURE__*/_react.default.createElement(ColumnBox, null, /*#__PURE__*/_react.default.createElement(CenterChildBox, null, width > theme.breakpoints.values.sm ? /*#__PURE__*/_react.default.createElement(_CoverArt.default, {
    className: "children",
    src: playlist[currentTrack]?.coverArt ?? defaultArt,
    sx: {
      height: "300px",
  ...
  return (
    ...
    _react.default.createElement(RootPaper, {
      ...
      sx: sx,
      elevation: 4
    }, rowView(), !disableDrawer && width <= theme.breakpoints.values.md && /*#__PURE__*/_react.default.createElement(_SwipeableDrawer2.default, {
      open: maximised,
      anchor: "bottom",
