...
function play(playlist) {
  const event = new CustomEvent(_types.CustomNativeEventTypes.PLAY, {
    detail: playlist
  });
 ...
 */
function pause() {
  const event = new CustomEvent(_types.CustomNativeEventTypes.PAUSE);
  window.dispatchEvent(event);
}
 ...
 */
function stop() {
  const event = new CustomEvent(_types.CustomNativeEventTypes.STOP);
  window.dispatchEvent(event);
}
...
function setVolume(level) {
  const event = new CustomEvent(_types.CustomNativeEventTypes.SET_VOLUME, {
    detail: level
  });
  window.dispatchEvent(event);
}
 ...
 */
function skipNext() {
  const event = new CustomEvent(_types.CustomNativeEventTypes.SKIP_NEXT);
  window.dispatchEvent(event);
}
 ...
 */
function skipPrev() {
  const event = new CustomEvent(_types.CustomNativeEventTypes.SKIP_PREV);
  window.dispatchEvent(event);
}
...
function shuffle(bool) {
  const event = new CustomEvent(_types.CustomNativeEventTypes.SHUFFLE, {
    detail: bool
  });
  window.dispatchEvent(event);
}
...
function seek(progress) {
  const event = new CustomEvent(_types.CustomNativeEventTypes.SEEK, {
    detail: progress
  });
  window.dispatchEvent(event);
}
...
function setRepeatMode(mode) {
  const event = new CustomEvent(_types.CustomNativeEventTypes.SET_REPEAT_MODE, {
    detail: mode
  });
  window.dispatchEvent(event);
}
...
function changeTrack(index) {
  const event = new CustomEvent(_types.CustomNativeEventTypes.CHANGE_TRACK, {
    detail: index
  });
  window.dispatchEvent(event);
}
...
function playNext(playlist) {
  const event = new CustomEvent(_types.CustomNativeEventTypes.PLAY_NEXT, {
    detail: playlist
  });
  window.dispatchEvent(event);
}
...
function playLater(playlist) {
  const event = new CustomEvent(_types.CustomNativeEventTypes.PLAY_LATER, {
    detail: playlist
  });
  window.dispatchEvent(event);
}
...
function setPlaylist(playlist) {
  const event = new CustomEvent(_types.CustomNativeEventTypes.SET_PLAYLIST, {
    detail: playlist
  });
  window.dispatchEvent(event);
}
...
function clearPlaylist() {
  const event = new CustomEvent(_types.CustomNativeEventTypes.CLEAR_PLAYLIST);
  window.dispatchEvent(event);
}
...
function subscribe(func) {
  _store.default.subscribe(() => func(getState()));
}
...
var _default = exports.default = interfaceObject;